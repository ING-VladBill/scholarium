...
<div class="container py-4">
    <h2 class="mb-4"><i class="bi bi-pencil-fill"></i> Editar Curso</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('nivel') is-invalid @enderror" 
                            ...
                            <option value="Básica" {{ old('nivel', $curso->nivel) == 'Básica' ? 'selected' : '' }}>Básica</option>
                            <option value="Media" {{ old('nivel', $curso->nivel) == 'Media' ? 'selected' : '' }}>Media</option>
                        </select>
                        @error('nivel')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('grado') is-invalid @enderror" 
                               id="grado" name="grado" value="{{ old('grado', $curso->grado) }}" 
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('seccion') is-invalid @enderror" 
                               id="seccion" name="seccion" value="{{ old('seccion', $curso->seccion) }}" 
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('anio_academico') is-invalid @enderror" 
                               ...
                               value="{{ old('anio_academico', $curso->anio_academico) }}" 
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('capacidad_maxima') is-invalid @enderror" 
                               ...
                               value="{{ old('capacidad_maxima', $curso->capacidad_maxima) }}" 
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('sala') is-invalid @enderror" 
                               id="sala" name="sala" value="{{ old('sala', $curso->sala) }}" 
