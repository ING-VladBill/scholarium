...
<div class="container">
        ...
        <div class="col-md-4 mb-3">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <h2 class="mt-3"><?php echo e($totalEstudiantes); ?></h2>
        ...
        <div class="col-md-4 mb-3">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <h2 class="mt-3"><?php echo e($totalCursos); ?></h2>
        ...
        <div class="col-md-4 mb-3">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <h2 class="mt-3"><?php echo e($totalMatriculas); ?></h2>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('estudiantes.index')); ?>" class="text-decoration-none">
        ...
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('cursos.index')); ?>" class="text-decoration-none">
                <div class="card h-100 hover-card">
                    <div class="card-body text-center">
        ...
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('matriculas.index')); ?>" class="text-decoration-none">
                <div class="card h-100 hover-card">
                    <div class="card-body text-center">
        ...
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('matriculas.listar')); ?>" class="text-decoration-none">
                <div class="card h-100 hover-card">
                    <div class="card-body text-center">
    ...
    <div class="row mb-4">
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('docentes.index')); ?>" class="text-decoration-none">
                <div class="card h-100 hover-card">
                    <div class="card-body text-center">
        ...
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('asignaturas.index')); ?>" class="text-decoration-none">
                <div class="card h-100 hover-card">
                    <div class="card-body text-center">
        ...
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('asignaciones.index')); ?>" class="text-decoration-none">
                <div class="card h-100 hover-card">
                    <div class="card-body text-center">
        ...
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('asignaciones.listar')); ?>" class="text-decoration-none">
                <div class="card h-100 hover-card">
                    <div class="card-body text-center">
        ...
        <div class="col-md-3 mb-3">
            <a href="<?php echo e(route('contactos.index')); ?>" class="text-decoration-none">
                <div class="card h-100 hover-card">
                    <div class="card-body text-center">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p><strong>Usuario:</strong> <?php echo e(Auth::user()->name); ?></p>
                            <p><strong>Rol:</strong> Administrador</p>
                        </div>
                        <div class="col-md-6">
                            <p><strong>Última sesión:</strong> <?php echo e(now()->format('d/m/Y H:i')); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\vladb\Desktop\CICLO 3\aplicaciones de internet\TRABAJO FINAL\scholarium FINAL\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>