...
<div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?php echo e(asset('images/slide1.jpg')); ?>" class="d-block w-100 carousel-img" alt="Educación de Calidad">
            <div class="carousel-caption">
                ...
                <a href="<?php echo e(route('nosotros')); ?>" class="btn btn-lg btn-gold mt-3">Conócenos</a>
            </div>
        </div>
        <div class="carousel-item">
            <img src="<?php echo e(asset('images/slide2.jpg')); ?>" class="d-block w-100 carousel-img" alt="Estudiantes">
            <div class="carousel-caption">
                ...
                <a href="<?php echo e(route('contacto')); ?>" class="btn btn-lg btn-gold mt-3">Contáctanos</a>
            </div>
        </div>
        <div class="carousel-item">
            <img src="<?php echo e(asset('images/slide3.jpg')); ?>" class="d-block w-100 carousel-img" alt="Aula Moderna">
            <div class="carousel-caption">
                ...
                <a href="<?php echo e(route('login')); ?>" class="btn btn-lg btn-gold mt-3">Ingresar al Sistema</a>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="gold-border-box">
                    ...
                    <div class="mt-4">
                        <a href="<?php echo e(route('nosotros')); ?>" class="btn btn-primary btn-lg me-2">
                            <i class="bi bi-info-circle me-2"></i>Más Información
                        </a>
                        <a href="<?php echo e(route('contacto')); ?>" class="btn btn-outline-gold btn-lg">
...
<section class="cta-section">
    <div class="container text-center">
        ...
        <div class="d-flex gap-3 justify-content-center flex-wrap">
            ...
            <a href="<?php echo e(route('contacto')); ?>" class="btn btn-outline-light btn-lg">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\vladb\Desktop\CICLO 3\aplicaciones de internet\TRABAJO FINAL\scholarium FINAL\resources\views/pages/home.blade.php ENDPATH**/ ?>