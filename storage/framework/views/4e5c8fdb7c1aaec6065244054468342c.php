<?php $__env->startSection('title', 'Nueva Asignatura'); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('asignaturas.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                      id="descripcion" name="descripcion" rows="3"><?php echo e(old('descripcion')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="horas_semanales" name="horas_semanales" value="<?php echo e(old('horas_semanales', 2)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="creditos" name="creditos" value="<?php echo e(old('creditos', 3)); ?>" 
                                       min="1" max="10" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\vladb\Desktop\CICLO 3\aplicaciones de internet\TRABAJO FINAL\scholarium FINAL\resources\views/asignaturas/create.blade.php ENDPATH**/ ?>