...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Scholarium'); ?> - Colegio Santa María de Jesús</title>
    ...
    <style>
        ...
        * {
        ...
        /* Navbar */
        .navbar-scholarium {
            background-color: var(--vinotinto-oscuro);
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('contacto') ? 'active' : ''); ?>" href="<?php echo e(route('contacto')); ?>">Contacto</a>
                    </li>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><span class="dropdown-item-text"><small>Rol: <?php echo e(ucfirst(Auth::user()->role)); ?></small></span></li>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(route('home')); ?>" class="text-white text-decoration-none">Inicio</a></li>
                        <li><a href="<?php echo e(route('nosotros')); ?>" class="text-white text-decoration-none">Nosotros</a></li>
                        <li><a href="<?php echo e(route('contacto')); ?>" class="text-white text-decoration-none">Contacto</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <h5>Contacto</h5>
                    <p>
                        <i class="bi bi-geo-alt-fill"></i> Santiago, Chile<br>
                        <i class="bi bi-telephone-fill"></i> +56 2 1234 5678<br>
                        <i class="bi bi-envelope-fill"></i> contacto@scholarium.cl
                    </p>
                </div>
            </div>
            <hr class="bg-white">
            <div class="text-center">
                <p class="mb-0">&copy; <?php echo e(date('Y')); ?> Scholarium. Todos los derechos reservados.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH /home/ubuntu/scholarium/resources/views/layouts/app.blade.php ENDPATH**/ ?>